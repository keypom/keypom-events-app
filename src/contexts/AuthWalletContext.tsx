...
// export const AuthWalletContextProvider: React.FC<PropsWithChildren> = ({ children }) => {
//   const [walletSelector, setWalletSelector] = useState<NearWalletSelector | null>(null);
...
//   const contextValue: AuthWalletContextValues = {
//     selector: walletSelector?.selector ?? null,
//     modal: walletSelector?.modal ?? null,
//     accounts: walletSelector?.accounts ?? [],
//     isInitialized,
//     error,
//   };
