...
import { RoundIcon } from "@/components/dashboard/iconBox/RoundIcon";
      ...
      {appModal.modalContent !== undefined ? (
        ...
        >
          ...
          <ModalBody>
            ...
            {appModal.bodyComponent !== undefined && (
              <Box>{appModal.bodyComponent}</Box>
            )}
